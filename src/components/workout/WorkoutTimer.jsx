...
export const WorkoutTimer = ({ startTime, endTime, className = "" }) => {
    ...
    const activeStyles = "bg-emerald-950/30 border-emerald-500/30 text-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.1)]";
    const inactiveStyles = "bg-zinc-900/50 border-zinc-800 text-zinc-500";
